...
#parentCatalogItemId         = "66799"
parentCatalogItemId         = ""
catalogItemId               = "67368"
#catalogItemId               = "67345"
#catalogItemId               = "67352" # DisMAP Regions
#catalogItemId               = "67362" # Survey Locations
defaultPointOfContactEmail  = "melissa.karp@noaa.gov"
defaultDataStewardEmail     = "tim.haverland@noaa.gov"
...
parameters = {
                ...
                'defaultPointOfContactEmail'  : defaultPointOfContactEmail,
                'defaultDataStewardEmail'     : defaultDataStewardEmail,
                'defaultMetadataContactEmail' : defaultMetadataContactEmail,
                'defaultOrganizationName'     : defaultOrganizationName
             }

del defaultEffectiveDate, parentCatalogItemId, catalogItemId
del defaultPointOfContactEmail, defaultDataStewardEmail
del defaultMetadataContactEmail, defaultOrganizationName
...
if datasets:
    try:
        ...
        print("###--->>> Something wrong with: {0} <<<---###".format(dataset))
        import sys, traceback
        # Get the traceback object
        tb = sys.exc_info()[2]
        tbinfo = traceback.format_tb(tb)[0]
...
del xslTemplatePath, mainXslFilename, projectFolder, importMetadataPath
